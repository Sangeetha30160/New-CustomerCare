...
public class CustomerCareController {
	...
	@DeleteMapping("/customercare/{customerId}")
	public ResponseEntity<String> deleteFeedbackById(@PathVariable Integer customerId) throws FeedbackNotFoundException {
		customerCareService.deleteFeedbackById(customerId);
